...
<html>
	...
	<head>
	    ...
	    <title>Hotel Verision 0.1</title>
   		<!-- jQuery (Va primero que bootstrap)-->	
...
<body>
	...
	<div id="wrapper">
	    ...
	    <div id="page-wrapper">
		    ...
		    <div class="well lead">Formulario Registro Cliente</div>
				<form:form method="POST" modelAttribute="cliente" class="form-horizontal">
					<form:input type="hidden" path="id" id="id" />
	
					<div class="row">
						<div class="form-group col-md-12">
							<label class="col-md-3 control-lable" for="Tipo_documento">Tipo de Documento</label>
							<div class="col-md-7">
								<form:select path="Tipo_documento" id="Tipo_documento">
									<form:option value="-1" label="Seleccionar Tipo Documento" />
									<form:option value="1" label="Pasaporte" />
									<form:option value="2" label="DNI" />
									<form:option value="3" label="Libreta Enrrolamiento" />
								</form:select>
								<div class="has-error">
									<form:errors path="Tipo_documento" class="help-inline" />
								</div>
							</div>
						</div>
					</div>
					...
					<div class="row">
						<div class="form-group col-md-12">
							<label class="col-md-3 control-lable" for="Nro_documento">Numero de Documento</label>
							<div class="col-md-7">
								<form:input type="text" path="Nro_documento" id="Nro_documento"
									class="form-control input-sm" />
								<div class="has-error">
									<form:errors path="nro_documento" class="help-inline" />
								</div>
							</div>
						</div>
					</div>
					...
					<div class="row">
						<div class="form-group col-md-12">
							<label class="col-md-3 control-lable" for="fechanacimiento">Fecha de Nacimiento</label>
							<div class="col-md-7">
					...
					<div class="row">
						<div class="form-group col-md-12">
							<label class="col-md-3 control-lable" for="Estado_civil">Estado Civil</label>
							<div class="col-md-7">
								<form:select path="Estado_civil" id="Estado_civil">
									<form:option value="-1" label="Seleccionar Estado Civil" />
									<form:option value="1" label="Casado" />
									<form:option value="2" label="Soltero" />
									<form:option value="3" label="Viudo" />
								</form:select>
								<div class="has-error">
									<form:errors path="Estado_civil" class="help-inline" />
								</div>
							</div>
						</div>
					</div>
					...
					<div class="row">
						<div class="form-group col-md-12">
							<label class="col-md-3 control-lable" for="ocupacion">Ocupacion</label>
							<div class="col-md-7">
								<form:input type="text" path="ocupacion" id="ocupacion"
									class="form-control input-sm" />
								<div class="has-error">
									<form:errors path="ocupacion" class="help-inline" />
								</div>
							</div>
						</div>
					</div>
					...
					<div class="row">
						<div class="form-group col-md-12">
							...
							<div class="col-md-7">
								<form:input type="text" path="domicilio" id="domicilio"
									class="form-control input-sm" />
								<div class="has-error">
								...
								<form:select path="Provincia" id="Provincia">
									...
									<c:if test="${editar}">
										<form:options items="${provincias}" itemValue="id"
											itemLabel="nombre" class="form-control input-sm" />
									</c:if>
								</form:select>
								<div class="has-error">
								...
								<form:select path="localidad" id="Localidad">
									...
									<c:if test="${editar}">
										<form:options items="${localidades}" itemValue="id"
											itemLabel="nombre" class="form-control imput-sm" />
									</c:if>
								</form:select>
								<div class="has-error">
							...
							<c:choose>
								<c:when test="${editar}">
									<input type="submit" value="Actualizar"
										...
										href="<c:url value='/listaclientes' />">Cancelar</a>
								</c:when>
								<c:otherwise>
